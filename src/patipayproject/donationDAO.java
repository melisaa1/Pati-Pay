        ...
        try (Connection conn = DBconnection.connect();
            ...
            while (rs.next()) {
                ...
                switch (type.toLowerCase()) {
                    case "para": totalScore += amount * paraPuan; break;
                    case "mama": totalScore += amount * mamaPuan; break;
                    case "su":   totalScore += amount * suPuan; break;
                }
            }
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public static List<String> getTopDonorsByScore() {
        ...
        try (Connection conn = DBconnection.connect();
            ...
            while (rs.next()) {
                ...
                double puan = switch (type.toLowerCase()) {
                    case "para" -> amount * paraPuan;
                    case "mama" -> amount * mamaPuan;
                    case "su"   -> amount * suPuan;
                    default     -> 0;
                };
